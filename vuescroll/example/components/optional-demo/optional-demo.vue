      ...
      <div ref="wrapper" class="page-content">
        <main class="main-content">
          ...
          <div class="options">
            ...
            <div class="option-list">  <slot name="options"></slot>  <!-- -->  </div> 
          </div>
          
          <div class="demo">
            <div class="title sub">Demo</div> <slot name="demo"></slot>  <!-- -->
          </div>
          
          <div class="methods">
            <div class="title sub">Methods</div>
            <ul class="method-list"><slot name="methods"></slot>  <!-- -->  </ul>
          </div>
